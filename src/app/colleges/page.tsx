...
export default function CollegesPage() {
  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-b from-[var(--background)] via-[var(--surface)] to-[var(--background)]">
      <div className="absolute inset-x-0 top-0 -z-10 h-72 bg-[radial-gradient(circle_at_top,_rgba(var(--primary-rgb),0.18),_transparent_60%)]" />
      <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-6 lg:grid-cols-[320px_minmax(0,1fr)]">
          <aside className="space-y-4 rounded-3xl border border-[var(--border)] bg-[var(--surface)]/90 p-4 shadow-sm backdrop-blur">
            <CollegeSearchBar
